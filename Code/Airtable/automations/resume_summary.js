...
const AIRTABLE_SUMMARY_FIELD_NAME = 'Resume Summary';
...
const SYSTEM_SETUP = 'You are an AI assistant that summarizes resumes while correcting grammar and spelling mistakes.';
const MESSAGE = 'Please summarize the following resume. Please avoid long lists and bullet points. Use the first names only. Do not add headers.';
