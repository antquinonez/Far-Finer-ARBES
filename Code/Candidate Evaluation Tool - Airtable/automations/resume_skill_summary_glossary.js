...
const AIRTABLE_OUTPUT_FIELD_NAME = 'Skill Glossary';
...
const SYSTEM_SETUP = 'You are an AI assistant that provides glossary definitions for the technologies in a skill summary list.';
const MESSAGE = `Please go through the list of technologies and provide an ALPHABETIZED list of glossary definitions for each.

Detailed Instructions:
-- Skip sections: 'Professional Skills' and 'Roles'. <-- These are not technologies.
-- Names of technologies come after the colon (':') in each section.
-- Do not include any extra preamble.
-- If there's more than 25 terms, focus on the primary, major technologies.
-- Provide a succinct sentence (less than 20 words) for each technology. Here's a glossary definition example for React: 
