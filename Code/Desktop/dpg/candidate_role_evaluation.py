...
def evaluate_callback():
    ...
    evaluation_technical_data = response.get('evaluation_main', empty_data)
    ...
    detailed_analysis_data = evaluation_technical_data + evaluation_database_data + evaluation_programming_data + evaluation_management_data + evaluation_credentials_data + evaluation_other_data
